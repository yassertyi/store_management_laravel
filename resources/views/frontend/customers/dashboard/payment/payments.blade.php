...
<div class="dashboard-main-content">
    <div class="container-fluid">
        ...
        <div class="form-box">
            ...
            {{-- فلترة المدفوعات --}}
            <form method="GET" action="{{ route('customer.payments.index') }}" class="mb-4">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-3 d-flex gap-2">
                        ...
                        <a href="{{ route('customer.payments.index') }}" class="btn btn-secondary w-100">
                    ...
                    <tbody>
                        @forelse($payments as $payment)
                            <tr>
                                ...
                                <td>{{ number_format($payment->discount ?? 0, 2) }} {{ $payment->currency }}</td>
