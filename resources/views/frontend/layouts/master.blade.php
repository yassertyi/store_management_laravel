...
<title>@yield('title', 'متجرنا - لوحة تحكم إدارة المتجر الإلكتروني')</title>
    <!-- Favicon -->
...
@yield('sidebar')   
    ...
    <script src="{{ asset('static/js/jquery.sparkline.js') }}"></script>
    <script src="{{ asset('static/js/dashboard.js') }}"></script>
    <script src="{{ asset('static/js/chart.js') }}"></script>
    <script src="{{ asset('static/js/chart.extension.js') }}"></script>
    <script src="{{ asset('static/js/bar-chart.js') }}"></script>
    <script src="{{ asset('static/js/line-chart.js') }}"></script>
    <script src="{{ asset('static/js/jquery.filer.min.js') }}"></script>
    <script src="{{ asset('static/js/jquery.ripples-min.js') }}"></script>
