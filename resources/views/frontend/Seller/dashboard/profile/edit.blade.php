                                ...
                                <div class="col-lg-6 responsive-column mb-3">
                                    <div class="input-box">
                                        ...
                                        <select name="gender" class="form-control">
                                            ...
                                            <option value="0" {{ old('gender', (string)$user->gender) === "0" ? 'selected' : '' }}>ذكر</option>
                                            <option value="1" {{ old('gender', (string)$user->gender) === "1" ? 'selected' : '' }}>أنثى</option>
                                        </select>
                                ...
                                <div class="col-lg-6 responsive-column">
                                    <div class="input-box">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" step="0.01" name="commission_rate" value="{{ old('commission_rate', $seller->commission_rate ?? 0) }}">
