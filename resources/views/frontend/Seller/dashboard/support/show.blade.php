    ...
    <div class="container-fluid py-4">
        ...
        <div class="chat-container">
            ...
            <div class="chat-footer">
                <form action="{{ route('seller.seller.support.messages.store', $ticket->ticket_id) }}" method="POST" class="message-form">
                    @csrf
        ...
        <!-- زر إغلاق التذكرة -->
        @if($ticket->status != 2)
        <form action="{{ route('seller.seller.support.close', $ticket->ticket_id) }}" method="POST" class="mt-2">
            @csrf
            <button type="submit" class="btn btn-danger">إغلاق التذكرة</button>
        </form>
        @endif
