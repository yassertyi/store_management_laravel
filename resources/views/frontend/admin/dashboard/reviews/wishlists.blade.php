                ...
                <div class="col-lg-12">
                    <div class="form-box">
                        <div class="form-title-wrap d-flex justify-content-between align-items-center">
                            ...
                            {{-- <a href="{{ route('admin.wishlists.create') }}" class="theme-btn theme-btn-small">
                                <i class="la la-plus"></i> إضافة جديد
                            </a> --}}
                        </div>

                        {{-- Flash Messages --}}
                        @if (session('success'))
                            <div id="flash-message" class="alert alert-success alert-dismissible fade show mt-2"
                                role="alert">
                                {{ session('success') }}
                            ...
                            @foreach ($wishlists as $wishlist)
                                <div class="card-item card-item-list">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="btn-box">
                                            <a href="{{ route('admin.products.show', $wishlist->product->product_id) }}"
                                    ...
                                    <div class="action-btns">
                                        <form action="{{ route('admin.wishlists.destroy', $wishlist->wishlist_id) }}"
                                            method="POST"
                                            onsubmit="return confirm('هل أنت متأكد من إزالة هذا المنتج من المفضلة؟');">
                                            @csrf
                                            @method('DELETE')
