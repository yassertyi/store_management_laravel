    ...
    <div class="container-fluid">
        ...
        <div class="form-box">
            ...
            <div class="form-content">
                <form action="{{ route('admin.products.variants.save') }}" method="POST">
                    @csrf
                        ...
                        <table class="table table-bordered text-center align-middle">
                            ...
                            <tbody>
                                ...
                                <tr class="variant-row" data-id="{{ $variant->variant_id }}">
                                    ...
                                    <td>
                                        <select name="variants[{{ $variant->variant_id }}][product_id]" class="form-control">
                                    ...
                                    <td><input type="text" name="variants[{{ $variant->variant_id }}][sku]" class="form-control" value="{{ $variant->sku }}"></td>
                                    <td>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    wrapper.addEventListener('click', function(e){
        if(e.target.classList.contains('remove-variant')){
            ...
            if(confirm('هل أنت متأكد من حذف هذا المتغير؟')){
                fetch(`{{ url('admin/products/variants') }}/${variantId}`, {
                    method: 'DELETE',
                    headers: {
    ...
    document.getElementById('add-variant-btn').addEventListener('click', function(){
        ...
        const index = Date.now(); // رقم فريد مؤقت
