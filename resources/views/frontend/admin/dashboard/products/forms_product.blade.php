            ...
            <div class="col-lg-9 mx-auto">
                ...
                <form action="{{ isset($product) ? route('admin.products.update', $product->product_id) : route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="input-box">
                                        ...
                                        <select name="store_id" class="form-control" required>
                                            ...
                                            @foreach($stores as $store)
                                                <option value="{{ $store->store_id }}" {{ (old('store_id', $product->store_id ?? '') == $store->store_id) ? 'selected' : '' }}>
                                                    {{ $store->store_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-6 responsive-column">
                                    <div class="input-box">
                                        ...
                                        <select name="status" class="form-control" required>
                                            ...
                                            <option value="suspended" {{ old('status', $product->status ?? '') == 'suspended' ? 'selected' : '' }}>معلق</option>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="submit-box mt-3">
                        ...
                        <a href="{{ route('admin.products.index') }}" class="theme-btn theme-btn-small bg-secondary">إلغاء</a>
                    </div>
